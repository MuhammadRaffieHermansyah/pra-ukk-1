            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('home') }}"
                            class="rounded-md {{ Route::is('/') ? 'bg-gray-900' : '' }} bg-gray-900 px-3 py-2 text-sm font-medium text-white"
                            aria-current="page">Dashboard</a>
                        <a href="{{ route('album.index') }}"
                            class="rounded-md {{ Route::is('/album') ? 'bg-gray-900' : '' }} px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Album</a>
                        <a href="#"
